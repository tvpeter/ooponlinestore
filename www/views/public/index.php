  <?php  require 'header.php';     ?>
                        ...
                        <div class="col-md-9 col-md-push-3">
                                ...
                                <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;">
                                    <ul>
                                        ...
                                        <li data-transition="fade">
                                            <!-- Background Image -->
                                            <img src="ass/images/transparent.png" class="rev-slidebg" style="background-color: #eeebe7;" alt="Slider bg">
                                            ...
                                            ><img src="ass/images/slider/item1.png" alt="Item" width="452" height="428" data-ww="['452px', '380px', '300px', '240px']" data-hh="['428px', '359px', '331px', '227px']"></div>
                                        </li>
                                        ...
                                        <li data-transition="fade">
                                            ...
                                            <div class="tp-caption tp-resizeme" 
                                                ...
                                                data-width="none"
                                                data-height="none">
                                                <img src="ass/images/slider/item2.png" alt="Item" width="365" height="454" data-ww="['365px', '300px', '240px', '200px']" data-hh="['454px', '373px', '298px', '248px']">
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            data-owl-responsive='{ "480": {"items": 2}, "768": {"items": 3}, "992": {"items": 3}, "1200": {"items": 4} }'>
                                <div class="product">
                                    <figure class="product-image-container">
                                        <a href="product" title="Product Name" class="product-image-link">
                                            <img class="owl-lazy" src="ass/images/blank.png" data-src="ass/images/products/product5.jpg" width="195" height="255" alt="Product Image">
                                        </a>
                                    ...
                                    <h3 class="product-title">
                                        <a href="product">Chandelier bulb</a>
                                    </h3>
                                ...
                                <div class="product">
                                    <figure class="product-image-container">
                                        <a href="product" title="Product Name" class="product-image-link">
                                            <img class="owl-lazy" src="ass/images/blank.png" data-src="ass/images/products/product10.jpg" width="195" height="255" alt="Product Image">
                                        </a>
                                        <a href="#" class="btn-quick-view">Quick View</a>
                                ...
                                <div class="product">
                                    <figure class="product-image-container">
                                        <a href="product" title="Product Name" class="product-image-link">
                                            <img class="owl-lazy" src="ass/images/blank.png" data-src="ass/images/products/product11.jpg" width="195" height="255" alt="Product Image">
                                        </a>
                                        <a href="#" class="btn-quick-view">Quick View</a>
                                ...
                                <div class="product">
                                    <figure class="product-image-container">
                                        <a href="product" title="Product Name" class="product-image-link">
                                            <img class="owl-lazy" src="ass/images/blank.png" data-src="ass/images/products/product12.jpg" width="195" height="255" alt="Product Image">
                                        </a>
                                        <a href="#" class="btn-quick-view">Quick View</a>
                                    ...
                                    <h3 class="product-title">
                                        <a href="product">Tripod lampshade</a>
                                    </h3>
                                    <div class="product-price-container">
                               ...
                               <div class="product">
                                    <figure class="product-image-container">
                                        <a href="product" title="Product Name" class="product-image-link">
                                            <img class="owl-lazy" src="ass/images/blank.png" data-src="ass/images/products/product14.jpg" width="195" height="255" alt="Product Image">
                                        </a>
                                        <a href="#" class="btn-quick-view">Quick View</a>
                                    ...
                                    <h3 class="product-title">
                                        <a href="product">Ceiling lights</a>
                                    </h3>
                                    <div class="product-price-container">
                            ...
                            <div class="banner banner-fullwidth">
                                ...
                                <div class="banner-image-wrapper">
                                    <a href="#"><img src="ass/images/banners/banner-full.jpg" alt="Banner"></a>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <ul class="products-list">
                                        <li class="product">
                                            <figure class="product-image-container">
                                                <a href="product">
                                                    <img src="ass/images/products/small/product1.jpg" alt="Product">
                                                </a>
                                            </figure>
                                            <div>
                                        ...
                                        <li class="product">
                                            <figure class="product-image-container">
                                                <a href="product">
                                                    <img src="ass/images/products/small/product2.jpg" alt="Product">
                                                </a>
                                            </figure>
                                            <div>
                                                <div class="ratings-container">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <ul class="products-list">
                                        <li class="product">
                                            <figure class="product-image-container">
                                                <a href="product">
                                                    <img src="ass/images/products/small/product3.jpg" alt="Product">
                                                </a>
                                            </figure>
                                            <div>
                                                <div class="ratings-container">
                                        ...
                                        <li class="product">
                                            <figure class="product-image-container">
                                                <a href="product">
                                                    <img src="ass/images/products/small/product4.jpg" alt="Product">
                                                </a>
                                            </figure>
                                            <div>
                                                <div class="ratings-container">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    data-owl-settings='{ "items":1, "margin": 5, "loop": false, "nav": true, "dots":false }'>
                                        <div class="banner banner-image">
                                            <a href="#">
                                                <img src="ass/images/banners/wanted-banner.jpg" alt="Banner">
                                            </a>
                                        ...
                                        <div class="banner banner-image">
                                            <a href="#">
                                                <img src="ass/images/banners/wanted-banner-2.jpg" alt="Banner">
                                            </a>
                                            <div class="wanted-banner-content">
        ...
        <?php require 'categoryWidget.php' ?>
                            ...
                            <div class="widget widget-banner">
                                <div class="banner banner-image">
                                    <a href="#" title="Brown Woman Shoes">
                                        <img src="ass/images/banners/widget-banner.png" alt="Banner name">
                                    </a>
                                </div>
                            </div><!-- End .widget -->
                            ...
                            <div class="widget widget-newsletter">
                                ...
                                <form action="#">
                                    <div class="form-group">
                                        <img src="ass/images/icon-newsletter-email.png" alt="Email">
                            ...
                            <div class="widget widget-testimonial">
                                ...
                                data-owl-settings='{ "items":1, "margin": 5, "loop": false, "nav": false, "dots":true }'>
                                    <div class="testimonial">
                                        <img src="ass/images/testimonials/user1.png" alt="User image">
                                    ...
                                    <div class="testimonial">
                                        <img src="ass/images/testimonials/user2.png" alt="User image">
                                    ...
                                    <div class="testimonial">
                                        <img src="ass/images/testimonials/user3.png" alt="User image">
